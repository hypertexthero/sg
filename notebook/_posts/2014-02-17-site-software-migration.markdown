...
SimonGriffee.com is now a static site with [custom dynamic bits](http://www.businessguide.co.uk/blog/jekyll-search-ways-to-search-a-static-site/) using the open source [Jekyll](http://jekyllrb.com/ "Known as a static site generator, Jekyll generates the files for the site on my personal computer. I then transfer them to the server.") publishing software. For you the main gain is the site is faster. To me it is more secure, simpler and lasting (HTML and plain text are the analogue film of the software world).
