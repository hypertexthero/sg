...
*Dear Internet, a request:* We need an online photo editing site _specialized in the traditional editing process of culling a collection of photos._ This site would let you upload a set of pictures, choose the best ones, arrange them in a sequence and save a unique URL with the new 'edit' to be sent to others for discussion. It could be built with a web framework such as [Django](http://djangoproject.com/ "For perfectionists with deadlines.") combined with revision control software such as [Git](http://git-scm.com/ "Fast version control."). Please make this, or I may have to!
